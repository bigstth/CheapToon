...
<div id="bgheader">
                        ...
                        <div class="jumbotron" id="idbox">
                            <div class="form-row">
                                ...
                                <?php if(isset($_SESSION['id'])){ ?>
                                   <p style="color:white;"> ยินดีต้อนรับ คุณ <?php echo $_SESSION['name']; ?>  <a href="myCartoon.php" class="btn btn-success">หนังสือการ์ตูนของฉัน</a> <a href="/logout.php" class="btn btn-danger">ออกจากระบบ</a></p>
                                    <?php }else{?>
        ...
        if(isset($_POST['submit'])){
                ...
                $sql = "INSERT INTO `user` (`id`, `name`, `password`, `email`, `tel`, `facebookUrl`) 
                        VALUES (NULL, '".$_POST['username']."', '".$_POST['password']."', '".$_POST['email']."', '".$_POST['tel']."', '".$_POST['facebook']."');";
    ...
    ?>
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="password2" class="col-form-label">ยืนยันรหัสผ่าน:</label>
                                        <input type="password2" class="form-control" name="password2" id="password2" required>
                                    </div>
